...
public class PshOtrDetPK implements Serializable {
	...
	public PshOtrDetPK(String bankId, String channelId, String pshReference) {
		super();
		this.bankId = bankId;
		this.channelId = channelId;
		this.pshReference = pshReference;
	...
	public String toString() {
		return "PshOtrDetPK [bankId=" + bankId + ", channelId=" + channelId + ", pshReference=" + pshReference + "]";
	}
