...
@Entity
@Table(name = "PSH_ITR_DET", schema = "IPSH")
public class PshItrDet implements Serializable {

	private static final long serialVersionUID = 1241850561500405226L;

	@EmbeddedId
	private PshItrDetPK id;
	
	@Column(name = "dep")
	@NotEmpty(message = "{NotEmpty.pshItrDet.dep}")
	@Pattern(regexp = Constants.PATTERN.ALPHANUMERICONLY, message = "{Pattern.pshItrDet.beneficiaryCustomerAccount}")
	private String dep;
...
//	@NotEmpty(message = "{NotEmpty.pshItrDet.beneficiaryCustomerAccount}")
//	@Pattern(regexp = Constants.PATTERN.ALPHANUMERICONLY, message = "{Pattern.pshItrDet.beneficiaryCustomerAccount}")
	...
	@Column(name = "repair_reason_code")
	private String repairReasonCode;
	
	@Column(name = "repair_reason_dcr")
	private String repairReasonDcr;
	...
	public PshItrDetPK getId() {
		return id;
	}

	public void setId(PshItrDetPK id) {
		this.id = id;
	}
	...
	public String getRepairReasonCode() {
		return repairReasonCode;
	}

	public void setRepairReasonCode(String repairReasonCode) {
		this.repairReasonCode = repairReasonCode;
	}

	public String getRepairReasonDcr() {
		return repairReasonDcr;
	}

	public void setRepairReasonDcr(String repairReasonDcr) {
		this.repairReasonDcr = repairReasonDcr;
	}
