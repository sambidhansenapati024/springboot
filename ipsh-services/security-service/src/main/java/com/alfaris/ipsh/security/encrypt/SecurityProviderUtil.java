package com.alfaris.ipsh.security.encrypt;
/**
...
public class SecurityProviderUtil {
    ...
    public static CsrfToken generateToken(HttpServletRequest request, String tokenName) {
        return new DefaultCsrfToken("csrf", tokenName, UUID.randomUUID().toString());
    }
