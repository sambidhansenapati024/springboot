...
*
** Project Name         : iPSH
** Program description  : UserLogRepository
** Version No           : 1.0.0
** Author               : Harichand
...
import com.alfaris.ipsh.security.entity.UserLogPk;

@Repository
public interface UserLogRepository extends JpaRepository<LogDetails, UserLogPk>,JpaSpecificationExecutor<LogDetails>{
